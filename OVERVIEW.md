...
> **Start here:** [read the two-minute Incident/RCA overview](README.md) before
...
| [Incident / RCA Forge app](#forge-incident--rca-status) | Adds an Incident context panel with **RCA missing**, **RCA incomplete**, **RCA completed**, or **RCA unknown** status. | Forge UI Kit, `issueContext`, Jira REST access, dynamic properties, and minimal scopes. | [`custom-apps/incident-rca-status/README.md`](custom-apps/incident-rca-status/README.md) |
